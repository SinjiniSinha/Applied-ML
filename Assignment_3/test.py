...
model_loc="Assignment 2/lgr.pkl"
...
class TestFunction:
    ...
    def test_spam(self):
        label,prop=score.score("Dear Parents! Urgent need of staff, get Rs. 19000!!!!!!!",model,threshold)
        assert label == 1


    def test_spam(self):
        label,prop=score.score("We are glad to have you onboard!",model,threshold)
        assert label == 0
